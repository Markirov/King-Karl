...
export function FichaHeraldicaLegacy({ pilot, pilotImg, apodoOverride, onAddQuirk, onSetWeapon, onSetArmadura, onSetArmadura2, onSetNotas, onUpgradeSkill, onUpgradeAttr, onAddSkill }: {
  pilot: Pilot;
  pilotImg?: string;
  ...
  const rank = dossier.clearanceNames[vetIdx].toUpperCase();
  const clearanceText = `${dossier.clearanceLabel} · ${dossier.clearanceNames[vetIdx]} (${ROMAN[vetIdx]})`;
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <HandField label="Apodo" val={apodoOverride?.trim() || pilot.apodo || pilot.callsign || '—'} big />
