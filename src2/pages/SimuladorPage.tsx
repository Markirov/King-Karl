        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-6 pb-20 max-w-7xl mx-auto px-2 md:px-0">
          ...
          <div className="col-span-1 md:col-span-3 space-y-4">
            ...
            <section className="bg-surface-container-low p-4 clip-chamfer border-l-2 border-primary-container/30">
              <h2 className="font-headline text-sm font-bold text-primary-container tracking-widest uppercase mb-3 flex items-center justify-between">
                Armas
                {sim.critModsAtkTotal > 0 && (
                  <span
                    className="font-mono text-[9px] text-amber-400 normal-case tracking-normal"
                    title="Penalización por componentes modificados (Gyro/Reactor/etc.), aplicada a todas las armas"
                  >
                    ⚠ +{sim.critModsAtkTotal} a toda tirada
                  </span>
                )}
              </h2>
              <div className="space-y-1">
                {ms.weapons.length === 0 ? (
                  ...
                  const weaponToHit = sim.gunneryTotal + armMod + wMod.atk + sim.critModsAtkTotal;
                  const effectiveHeat = w.heat + wMod.heat;
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2 text-[9px]">
                        ...
                        <button
                          onClick={(e) => {
                            e.stopPropagation();
                            setAdjustTarget({ kind: 'weapon', id: w.id, label: `${w.name} (${w.loc})`, heat: wMod.heat, atk: wMod.atk });
                          }}
                          title="Ajustar calor/dificultad de esta arma"
