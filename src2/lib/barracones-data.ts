...
export const SKILLS_CATALOG: SkillDef[] = [
  ...
  { nombre: 'Administracion',        attr: 'int' },
  { nombre: 'Arco',                  attr: 'des' },
  { nombre: 'AstroNavegacion',       attr: 'int' },
  { nombre: 'AstroPilotaje',         attr: 'des' },
  { nombre: 'Atletismo',             attr: 'fue' },
  { nombre: 'Callejeo',              attr: 'car' },
  { nombre: 'Conducir',              attr: 'des' },
  { nombre: 'Diplomacia',            attr: 'car' },
  { nombre: 'Disparo Aeroespacial',  attr: 'des' },
  { nombre: 'Disparo Artilleria',    attr: 'des' },
  { nombre: 'Disparo Mech',          attr: 'des' },
  { nombre: 'Equitacion',            attr: 'des' },
  { nombre: 'Espada',                attr: 'des' },
  { nombre: 'Informatica',           attr: 'int' },
  { nombre: 'Ingenieria',            attr: 'int' },
  { nombre: 'Interrogacion',         attr: 'car' },
  { nombre: 'Liderazgo',             attr: 'car' },
  { nombre: 'Mecanica',              attr: 'int' },
  { nombre: 'Pelea',                 attr: 'fue' },
  { nombre: 'Pilotaje Mech',         attr: 'des' },
  { nombre: 'Pilotar Aeroespacial',  attr: 'des' },
  { nombre: 'Pistola',               attr: 'des' },
  { nombre: 'Primeros Auxilios',     attr: 'int' },
  { nombre: 'Rifle',                 attr: 'des' },
  { nombre: 'Robar',                 attr: 'des' },
  { nombre: 'Seguridad',             attr: 'int' },
  { nombre: 'Supervivencia',         attr: 'fue' },
  { nombre: 'Tacticas',              attr: 'int' },
  { nombre: 'Tecnica Mech',          attr: 'int' },
];
