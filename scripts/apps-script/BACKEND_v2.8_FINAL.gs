/**
 * ============================================================================
 * MECHWARRIOR — BACKEND v2.8 (Telegram integrado)
 * ============================================================================
 *
 * Base v2.7 + Telegram bot completo (saliente desde web + comandos entrantes).
 *
 * COPIAR ESTE ARCHIVO ENTERO sobre el Code.gs existente.
 * Después: Deploy → New deployment → Web app → Execute as: Me → Anyone.
 * Copiar /exec URL → pegarla en TELEGRAM_WEBAPP_URL abajo → ejecutar
 * resetWebhookNuclear() una vez desde editor.
 *
 * Sheets esperadas:
...
const TELEGRAM_WEBAPP_URL = 'https://script.google.com/macros/s/AKfycbwoJZUWvAR0mclvVHVzHzrJyzeFh2aJoVKt7cjhKJnZx89mBPH7dregKkjjsVFudaQNqw/exec';
...
function resetWebhookNuclear() {
  ...
  // Paso 1: borrar webhook y destruir mensajes atascados
  ...
  // Paso 2: setear webhook con URL limpia
...
function cmdBackup(chatId) {
  // Placeholder: si tienes lógica de snapshot, hookéala aquí
